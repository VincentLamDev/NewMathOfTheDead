...
class GameOverScene: SKScene {
    ...
    init(size: CGSize, won:Bool, score: Int, wave: Int) {
        ...
        var scoreLabelScaleFactor = min((self.frame.width * 0.7) / scorelabel.frame.width, (self.frame.height * 0.15) / scorelabel.frame.height)
        ...
        var killLabelScaleFactor = min((self.frame.width * 0.55) / killslabel.frame.width, (self.frame.height * 0.15) / killslabel.frame.height)
